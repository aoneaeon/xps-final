document.addEventListener('DOMContentLoaded', () => {
    ...
    const lotData = {
        ...
        "14, Block 1": { sqm: 1000, price: "₱-------", status: "Sold", notes: "" },
        "1, Block 2": { sqm: 745, price: "₱-------", status: "Sold", notes: "" },
        "1, Block 3": { sqm: 1001, price: "₱1,500 per sqm", status: "Available", notes: "" },
        "2, Block 3": { sqm: 1149, price: "₱1,800 per sqm", status: "Available", notes: "Premium lot." },
        ...
        "9, Block 3": { sqm: 1000, price: "₱1,500 per sqm", status: "Available", notes: "" },
        "10, Block 3": { sqm: 585, price: "₱-------", status: "Sold", notes: "" },
        ...
        "1, Block 5": { sqm: 1205, price: "₱-------", status: "Sold", notes: "" },
        "2, Block 5": { sqm: 820, price: "₱1,500 per sqm", status: "Available", notes: "" },
        "3, Block 5": { sqm: 1204, price: "₱1,500 per sqm", status: "Available", notes: "Largest lot in Block 5." },
        "4, Block 5": { sqm: 1033, price: "₱1,500 per sqm", status: "Available", notes: "" },
    };
